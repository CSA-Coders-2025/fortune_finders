...
class QuizManager {
    ...
    async attemptQuizForNpc(npcCategory, callback = null) {
        try {
            ...
            const quiz = new Quiz(this.game); // FIX: pass the Game/Fintech instance, not QuizManager
            quiz.initialize();
...
class Fintech extends Game {
    constructor(environment) {
        super(environment);
        // All game logic, managers, and features from the old Game.js
        ...
        this.userTracker.showGameInstructions();
        this.getNpcCookiesDisplayHTML = this.getNpcCookiesDisplayHTML.bind(this);
        this.initProgressBar = this.initProgressBar.bind(this);
        this.updateProgressBar = this.updateProgressBar.bind(this);
        this.showCompletionCelebration = this.showCompletionCelebration.bind(this);
        this.createCelebrationFirework = this.createCelebrationFirework.bind(this);
        this.giveItem = this.giveItem.bind(this);
        this.removeItem = this.removeItem.bind(this);
        this.hasItem = this.hasItem.bind(this);
        this.getItemQuantity = this.getItemQuantity.bind(this);
        this.attemptQuizForNpc = this.attemptQuizForNpc.bind(this);
        this.giveNpcCookie = this.giveNpcCookie.bind(this);
        this.getNpcCookie = this.getNpcCookie.bind(this);
        this.getAllNpcCookies = this.getAllNpcCookies.bind(this);
        this.initAudioToggle = this.initAudioToggle.bind(this);
        this.playConfirmationSound = this.playConfirmationSound.bind(this);
        this.showAudioToggleFeedback = this.showAudioToggleFeedback.bind(this);
